...
public enum ModToolMaterial implements ToolMaterial
    {
//        WOOD(MiningLevels.WOOD, 59, 2.0f, 0.0f, 15, () -> Ingredient.fromTag(ItemTags.PLANKS)), //Minecrafts defaults
...
//        NETHERITE(MiningLevels.NETHERITE, 2031, 9.0f, 4.0f, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT));
        PINK_GARNET(5, 4062, 10.0f, 6.0f, 30, () -> Ingredient.ofItems(ModItems.PINK_GARNET));
